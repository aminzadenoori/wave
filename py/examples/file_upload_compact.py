    ...
    if 'file_upload' in q.args:
        ...
        q.page['example'] = ui.form_card(
            ...
            items=[
                ...
                ui.file_upload(name='file_upload2', label='Select one or more files to upload', compact=True,
                               multiple=True, file_extensions=['jpg', 'png'], max_file_size=1, max_size=15),
                ui.file_upload(name='file_upload3', label='Select one or more files to upload', compact=True,
                               multiple=True, file_extensions=['jpg', 'png'], max_file_size=1, max_size=15),
